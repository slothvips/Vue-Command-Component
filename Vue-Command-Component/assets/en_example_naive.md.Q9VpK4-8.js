...
`,W={class:"flex justify-center items-center"},O=_({__name:"naiveui",setup(k){const a=E(),c=x(),n=()=>{c(e(h,null,{default:()=>[e(d,null,null)]}),{attrs:{style:{width:"600px"}}})},o=A(),v=()=>{o(e(d,null,null),{attrs:{style:{width:"600px"}}})},g=N(),f=()=>{g(e(h,null,{default:()=>[e(d,null,null)]}),{attrs:{drawerAttrs:{placement:"right",width:600},contentAttrs:{title:a.drawerTitle}}})};return(I,S)=>{const r=T;return m(),u("div",W,[e(r,{onClick:n},{default:l(()=>[t(p(s(a).comeOn),1)]),_:1}),e(r,{onClick:v},{default:l(()=>[t(p(s(a).comeOnPreset),1)]),_:1}),e(r,{onClick:f},{default:l(()=>[t(p(s(a).drawerButton),1)]),_:1})])}}}),q=JSON.parse('{"title":"Naive UI","description":"","frontmatter":{},"headers":[],"relativePath":"en/example/naive.md","filePath":"en/example/naive.md"}'),V={name:"en/example/naive.md"},G=Object.assign(V,{setup(k){const a=C(!0);return(c,n)=>{const o=b("ClientOnly");return m(),u("div",null,[n[1]||(n[1]=y(`<h1 id="naive-ui" tabindex="-1">Naive UI <a class="header-anchor" href="#naive-ui" aria-label="Permalink to &quot;Naive UI&quot;">​</a></h1><p>This page demonstrates several <code>Naive UI</code> components.</p><p>To use the imperative components for <code>naive-ui</code>, install the <code>@vue-cmd/naive</code> package.</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># npm</span></span>
