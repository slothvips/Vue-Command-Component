...
<style lang="scss" scoped></style>
`,ls=JSON.parse('{"title":"常规用法","description":"","frontmatter":{},"headers":[],"relativePath":"example/base.md","filePath":"example/base.md"}'),ss={name:"example/base.md"},hs=Object.assign(ss,{setup(F){const n=_(!0);return(o,s)=>{const t=x("ClientOnly");return m(),y("div",null,[s[9]||(s[9]=f(`<h1 id="常规用法" tabindex="-1">常规用法 <a class="header-anchor" href="#常规用法" aria-label="Permalink to &quot;常规用法&quot;">​</a></h1><p>这里展示一些常见的使用方式。</p><p>弹窗是命令式组件最典型的应用场景，因此示例使用 <code>element-plus</code> 的 <code>dialog</code> 组件进行演示。通过这些示例，可以举一反三地理解其他组件的使用方式。</p><p>要使用<code>element-plus</code>的<code>dialog</code>组件,需要安装<code>@vue-cmd/element-plus</code>包.</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 使用npm</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    });</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  };</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">};</span></span></code></pre></div>`,7))])}}});export{ls as __pageData,hs as default};
