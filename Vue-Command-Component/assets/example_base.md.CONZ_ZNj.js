import{j as C,C as E,G as y,k as i,J as l,B as h,u as a,r as A,X as f,aD as v,t as r,P as p,v as d}from"./chunks/framework.ZlEsIilh.js";import{H as o,T as B,L as u,K as D,O as c,M as g,P as _}from"./chunks/index.Bahcyccm.js";import{T as w}from"./chunks/nested.CqEPtGev.js";import"./chunks/theme.EkMg1Mgs.js";const W=`<template>
...
<style lang="scss" scoped></style>
`,X={class:"flex justify-center items-center"},z=C({__name:"base",setup(m){const n=D(),k=()=>{n(i(u,null,null),{title:"hello world",width:"90%"})};return(s,e)=>{const t=o;return y(),E("div",X,[i(t,{onClick:k},{default:l(()=>e[0]||(e[0]=[h("打开弹窗")])),_:1,__:[0]})])}}}),N=`<script lang="tsx" setup>
