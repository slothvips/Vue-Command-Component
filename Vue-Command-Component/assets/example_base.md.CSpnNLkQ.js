import{j as C,C as E,G as y,k as i,J as l,B as h,u as a,r as A,X as f,aY as v,t as r,P as p,v as d}from"./chunks/framework.Cdqz12yZ.js";import{T as B,_ as u,x as D,O as c,E as g,a as _}from"./chunks/index.Bv9V6kn_.js";import{a as o}from"./chunks/theme.B-R_-AgB.js";import{T as w}from"./chunks/nested.CqEPtGev.js";const W=`<template>
...
<style lang="scss" scoped></style>
`,S={class:"flex justify-center items-center"},X=C({__name:"showhide",setup(m){const n=D();let k;const s=()=>{k=n(i(u,null,null),{title:"hello world",attrs:{"close-on-click-modal":!1}}),k.hide()};return s(),(e,t)=>{const F=o;return y(),E("div",S,[i(F,{onClick:t[0]||(t[0]=b=>a(k).show())},{default:l(()=>t[3]||(t[3]=[h("显示弹窗")])),_:1,__:[3]}),i(F,{onClick:t[1]||(t[1]=b=>a(k).hide())},{default:l(()=>t[4]||(t[4]=[h("隐藏弹窗")])),_:1,__:[4]}),i(F,{onClick:t[2]||(t[2]=b=>s())},{default:l(()=>t[5]||(t[5]=[h("重新创建一个弹窗🌟")])),_:1,__:[5]})])}}}),z=`<template>
  <div class="flex justify-center items-center">
    <el-button @click="openDialog">打开弹窗</el-button>
  </div>
</template>
...
<style lang="scss" scoped></style>
`,L={class:"flex justify-center items-center"},M=C({__name:"base",setup(m){const n=D(),k=()=>{n(i(u,null,null),{title:"hello world",width:"90%"})};return(s,e)=>{const t=o;return y(),E("div",L,[i(t,{onClick:k},{default:l(()=>e[0]||(e[0]=[h("打开弹窗")])),_:1,__:[0]})])}}}),N=`<script lang="tsx" setup>
...
<style lang="scss" scoped></style>
`,K=JSON.parse('{"title":"常规用法","description":"","frontmatter":{},"headers":[],"relativePath":"example/base.md","filePath":"example/base.md"}'),U={name:"example/base.md"},ss=Object.assign(U,{setup(m){const n=A(!0);return(k,s)=>{const e=f("ClientOnly");return y(),E("div",null,[s[8]||(s[8]=v(`<h1 id="常规用法" tabindex="-1">常规用法 <a class="header-anchor" href="#常规用法" aria-label="Permalink to &quot;常规用法&quot;">​</a></h1><p>这里展示一些常见的使用方式。</p><p>弹窗是命令式组件最典型的应用场景，因此示例使用 <code>element-plus</code> 的 <code>dialog</code> 组件进行演示。通过这些示例，可以举一反三地理解其他组件的使用方式。</p><p>要使用<code>element-plus</code>的<code>dialog</code>组件,需要安装<code>@vue-cmd/core</code>和<code>@vue-cmd/element-plus</code>两个包.</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 使用npm</span></span>
