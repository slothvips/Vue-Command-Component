import{d as F,c as u,o as y,G as i,w as t,a as l,k as a,p as A,C as f,aH as v,af as o,j as e,ag as d}from"./chunks/framework.CvJfJ0fb.js";import{aH as g,aR as D,aS as E,aV as r,aW as c,aX as B}from"./chunks/index.Gvba-8xK.js";const _=`<template>
...
<style lang="scss" scoped></style>
`,U=JSON.parse('{"title":"常规用法","description":"","frontmatter":{},"headers":[],"relativePath":"example/base.md","filePath":"example/base.md"}'),q={name:"example/base.md"},$=Object.assign(q,{setup(m){const n=A(!0);return(k,s)=>{const h=f("ClientOnly");return y(),u("div",null,[s[7]||(s[7]=v('<h1 id="常规用法" tabindex="-1">常规用法 <a class="header-anchor" href="#常规用法" aria-label="Permalink to &quot;常规用法&quot;">​</a></h1><p>这里展示一些常见的使用方式。</p><p>示例中展示的所有 API，在弹窗内部都可以使用 <code>useConsumer</code> 获取到同一个 <code>consumer</code> 对象。弹窗内部和外部获取到的 <code>consumer</code> 是全等的，功能完全相同。</p><p>弹窗是命令式组件最典型的应用场景，因此示例使用 <code>element-plus</code> 的 <code>dialog</code> 组件进行演示。通过这些示例，可以举一反三地理解其他组件的使用方式。</p><h2 id="前菜" tabindex="-1">前菜 <a class="header-anchor" href="#前菜" aria-label="Permalink to &quot;前菜&quot;">​</a></h2><h3 id="dialogcontent展示" tabindex="-1">DialogContent展示 <a class="header-anchor" href="#dialogcontent展示" aria-label="Permalink to &quot;DialogContent展示&quot;">​</a></h3><p>示例中会多次使用弹窗内容组件<code>dialog-content</code>,下边是它的样子:</p><div class="warning custom-block"><p class="custom-block-title">☕️☕️☕️别着急进行交互,我们并没有真正的开始,这个组件需要和命令式组件配合使用,所以你点击下边的按钮是没有任何反应的</p></div>',8)),o(i(a(r),null,null,512),[[d,n.value]]),i(h,null,{default:t(()=>[i(a(c),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:s[0]||(s[0]=()=>{n.value=!1}),vueCode:a(X)},{vue:t(()=>[i(E)]),_:1},8,["vueCode"])]),_:1}),s[8]||(s[8]=v(`<h3 id="consumer对象" tabindex="-1">consumer对象 <a class="header-anchor" href="#consumer对象" aria-label="Permalink to &quot;consumer对象&quot;">​</a></h3><p>consumer是一个重要的对象,它是命令组件内外通信的桥梁,它身上尽可能的多的向我们暴露了我们可能用到的属性和方法.在弹窗内部可以使用<code>useConsumer</code>来获取,而在弹窗外部可以调用<code>useDialog</code>创建的命令函数来获取,他们是同一个对象,所以你会发现是全等的.</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 外部</span></span>
