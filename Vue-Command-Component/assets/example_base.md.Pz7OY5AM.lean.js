import{j as C,C as y,G as E,k as i,J as l,B as h,u as a,r as A,X as f,aN as v,t as r,P as p,v as d}from"./chunks/framework.BtNxmiVb.js";import{a7 as o,an as B,ai as u,ah as D,al as c,am as g,ao as _}from"./chunks/index.D5cWYCeG.js";import"./chunks/theme.CvCdYeWl.js";const w=`<template>
...
<style lang="scss" scoped></style>
`,L={class:"flex justify-center items-center"},N=C({__name:"base",setup(m){const n=D(),k=()=>{n(i(u,null,null),{title:"hello world",width:"90%"})};return(s,e)=>{const t=o;return E(),y("div",L,[i(t,{onClick:k},{default:l(()=>e[0]||(e[0]=[h("打开弹窗")])),_:1,__:[0]})])}}}),M=`<script lang="tsx" setup>
