import{k as l,q as P,j as D,r as k,C as b,G as g,B as r,J as m,H as f,X as E,aD as A,t as O,P as d,v as w,u as v}from"./chunks/framework.ZlEsIilh.js";import{S as T,H as S,J as W,L as j,O as N,P as I}from"./chunks/index.CIQb551O.js";import{P as Z,F as q,C as U}from"./chunks/theme.EkMg1Mgs.js";const G=`<template>
  <div>
...
`;var L=Object.defineProperty,c=Object.getOwnPropertySymbols,F=Object.prototype.hasOwnProperty,C=Object.prototype.propertyIsEnumerable,y=(t,n,a)=>n in t?L(t,n,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[n]=a,M=(t,n)=>{for(var a in n||(n={}))F.call(n,a)&&y(t,a,n[a]);if(c)for(var a of c(n))C.call(n,a)&&y(t,a,n[a]);return t},Q=(t,n)=>{var a={};for(var e in t)F.call(t,e)&&n.indexOf(e)<0&&(a[e]=t[e]);if(t!=null&&c)for(var e of c(t))n.indexOf(e)<0&&C.call(t,e)&&(a[e]=t[e]);return a};const _={round:!0,lockScroll:!0},Y=(t,{componentRef:n,visible:a,onMounted:e,config:i,consumer:h})=>{const u=i.value,{attrs:o}=u,s=Q(u,["attrs"]),p=()=>{h.value.destroy()};return l(Z,P({ref:n,show:a.value,onClickCloseIcon:p,onVnodeMounted:e},_,s,o),M({default:()=>t},i.value.slots))},z=T({render:Y,defaultConfig:{attrs:_}}),J=D({__name:"vant",setup(t){const n=z({}),a=()=>{n(l(j,null,null),{attrs:{position:"center",round:!0,closeable:!0,style:{width:"375px",height:"667px"}}})},e=k(""),i=k(""),h=[{text:"浙江省",value:"330000",children:[{text:"杭州市",value:"330100"}]},{text:"江苏省",value:"320000",children:[{text:"南京市",value:"320100"}]}],u=()=>{const o=n(l(U,{modelValue:i.value,"onUpdate:modelValue":s=>i.value=s,title:"请选择所在地区",options:h,onClose:()=>{o.destroy()},onFinish:({selectedOptions:s})=>{e.value=s.map(p=>p.text).join("/"),o.destroy()}},null),{position:"bottom",appendTo:"body",attrs:{round:!0,style:{width:"375px",height:"667px"}}})};return(o,s)=>{const p=S,x=W,V=q;return g(),b("div",null,[l(p,{onClick:a},{default:m(()=>s[1]||(s[1]=[r("打开Vant弹窗")])),_:1,__:[1]}),l(x),r(" "+f(e.value)+" "+f(i.value)+" ",1),l(V,{modelValue:e.value,"onUpdate:modelValue":s[0]||(s[0]=B=>e.value=B),"is-link":"",readonly:"",label:"地区",placeholder:"请选择所在地区",onClick:u},null,8,["modelValue"])])}}}),K=JSON.parse('{"title":"Vant示例","description":"","frontmatter":{},"headers":[],"relativePath":"example/vant.md","filePath":"example/vant.md"}'),R={name:"example/vant.md"},ee=Object.assign(R,{setup(t){const n=k(!0);return(a,e)=>{const i=E("ClientOnly");return g(),b("div",null,[e[1]||(e[1]=A(`<h1 id="vant示例" tabindex="-1">Vant示例 <a class="header-anchor" href="#vant示例" aria-label="Permalink to &quot;Vant示例&quot;">​</a></h1><p>本页面展示如何使用Vant UI组件库的适配器。</p><p>要使用Vant的命令式组件，需要安装<code>@vue-cmd/core</code>和<code>@vue-cmd/vant</code>两个包：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 使用npm</span></span>
