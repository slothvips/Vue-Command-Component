import{k as s,q as O,j as A,r as b,C as _,E as C,B as i,I as r,G as g,W as w,aW as T,t as W,O as h,v as S,u as f}from"./chunks/framework.BdKND-4d.js";import{F as j,_ as N,O as I,E as U}from"./chunks/index.JxdIIUY9.js";import{m as Z,P as q,a as G,E as M,F as Q,B as Y,C as z}from"./chunks/theme.6JvfIMAU.js";const L=`<template>
  <div>
...
`;var R=Object.defineProperty,v=Object.getOwnPropertySymbols,B=Object.prototype.hasOwnProperty,V=Object.prototype.propertyIsEnumerable,F=(a,e,t)=>e in a?R(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t,X=(a,e)=>{for(var t in e||(e={}))B.call(e,t)&&F(a,t,e[t]);if(v)for(var t of v(e))V.call(e,t)&&F(a,t,e[t]);return a},$=(a,e)=>{var t={};for(var n in a)B.call(a,n)&&e.indexOf(n)<0&&(t[n]=a[n]);if(a!=null&&v)for(var n of v(a))e.indexOf(n)<0&&V.call(a,n)&&(t[n]=a[n]);return t};const x={round:!0,lockScroll:!0},J=(a,{componentRef:e,visible:t,onMounted:n,config:o,consumer:u})=>{const d=o.value,{attrs:m}=d,k=$(d,["attrs"]),p=()=>{u.value.destroy()};return s(q,O({ref:e,show:t.value,"onUpdate:show":l=>t.value=l,onClickCloseIcon:p,onVnodeMounted:n},x,k,m),X({default:()=>a},o.value.slots))},E=j({render:J,defaultConfig:{attrs:x}}),H=(a={})=>{const e=E(a);return(t,n={})=>{const o=Z({},n,{attrs:{position:"bottom",style:{width:"100vw"}}});return e(t,o)}},K=A({__name:"vant",setup(a){const e=E({}),t=H(),n=()=>{e(s(N,null,null),{attrs:{position:"center",round:!0,closeable:!0,style:{width:"375px",height:"667px"}}})},o=b(""),u=b(""),d=[{text:"浙江省",value:"330000",children:[{text:"杭州市",value:"330100"}]},{text:"江苏省",value:"320000",children:[{text:"南京市",value:"320100"}]}],m=()=>{const p=t(s("div",{style:"padding: 20px;"},[s("h3",null,[i("底部弹出示例")]),s("p",null,[i("这是一个从底部弹出的弹窗")]),s(Y,{type:"primary",onClick:()=>{p.destroy()},style:"margin-top: 20px; width: 100%;"},{default:()=>[i("关闭")]})]))},k=()=>{const p=t(s(z,{modelValue:u.value,"onUpdate:modelValue":l=>u.value=l,title:"请选择所在地区",options:d,onClose:()=>{p.destroy()},onFinish:({selectedOptions:l})=>{o.value=l.map(c=>c.text).join("/"),p.destroy()}},null),{appendTo:"body",attrs:{round:!0,style:{}}})};return(p,l)=>{const c=G,y=M,P=Q;return C(),_("div",null,[s(c,{onClick:n},{default:r(()=>l[1]||(l[1]=[i("打开Vant弹窗")])),_:1,__:[1]}),s(y),s(y,null,{default:r(()=>l[2]||(l[2]=[i("底部弹窗")])),_:1,__:[2]}),s(c,{onClick:m},{default:r(()=>l[3]||(l[3]=[i("打开底部弹窗")])),_:1,__:[3]}),s(y,null,{default:r(()=>l[4]||(l[4]=[i("示例:地区选择")])),_:1,__:[4]}),i(" "+g(o.value)+" "+g(u.value)+" ",1),s(P,{modelValue:o.value,"onUpdate:modelValue":l[0]||(l[0]=D=>o.value=D),"is-link":"",readonly:"",label:"地区",placeholder:"请选择所在地区",onClick:k},null,8,["modelValue"])])}}}),sn=JSON.parse('{"title":"Vant示例","description":"","frontmatter":{},"headers":[],"relativePath":"example/vant.md","filePath":"example/vant.md"}'),nn={name:"example/vant.md"},ln=Object.assign(nn,{setup(a){const e=b(!0);return(t,n)=>{const o=w("ClientOnly");return C(),_("div",null,[n[1]||(n[1]=T(`<h1 id="vant示例" tabindex="-1">Vant示例 <a class="header-anchor" href="#vant示例" aria-label="Permalink to &quot;Vant示例&quot;">​</a></h1><p>本页面展示如何使用Vant UI组件库的适配器。</p><p>要使用Vant的命令式组件，需要安装<code>@vue-cmd/vant</code>包：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 使用npm</span></span>
