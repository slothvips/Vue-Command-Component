...
`,Qa={__name:"comparison-traditional-workflow",setup(e){const i=T(!1),l=T(!1),t=T(!1),a=T(""),f=T({}),n=()=>{a.value="",f.value={},i.value=!0},m=({data:h})=>{a.value=h,i.value=!1,l.value=!0},v=({data:h})=>{f.value=h,l.value=!1,t.value=!0},d=h=>{t.value=!1,console.log("工作流结果:",h)},c=()=>{l.value=!1,i.value=!0},r=()=>{t.value=!1,l.value=!0};return(h,g)=>{const k=oe,O=ht;return b(),D("div",null,[g[7]||(g[7]=V("h4",null,"多步骤工作流 - 传统方式",-1)),s(k,{onClick:n,type:"primary"},{default:p(()=>g[6]||(g[6]=[B("开始工作流")])),_:1,__:[6]}),s(O,{modelValue:i.value,"onUpdate:modelValue":g[1]||(g[1]=N=>i.value=N),title:"步骤1: 选择数据",width:"500px"},{default:p(()=>[s(Rn,{onNext:m,onCancel:g[0]||(g[0]=N=>i.value=!1)})]),_:1},8,["modelValue"]),s(O,{modelValue:l.value,"onUpdate:modelValue":g[3]||(g[3]=N=>l.value=N),title:"步骤2: 编辑内容",width:"600px"},{default:p(()=>[s(Tt,{"data-type":a.value,onNext:v,onBack:c,onCancel:g[2]||(g[2]=N=>l.value=!1)},null,8,["data-type"])]),_:1},8,["modelValue"]),s(O,{modelValue:t.value,"onUpdate:modelValue":g[5]||(g[5]=N=>t.value=N),title:"步骤3: 确认提交",width:"500px"},{default:p(()=>[s($n,{"data-type":a.value,"edit-data":f.value,onSubmit:d,onBack:r,onCancel:g[4]||(g[4]=N=>t.value=!1)},null,8,["data-type","edit-data"])]),_:1},8,["modelValue"])])}}},Ya=ce(Qa,[["__scopeId","data-v-ad4aebfc"]]),Xa=`<template>
  <div>
    <h4>表格编辑 - 命令式</h4>
    <UserTable
      :data="tableData"
...
<\/script>
`,as=U({__name:"comparison-command-basic",setup(e){const i=gt(),l=async()=>{try{const t=await i(s(wt,{user:Nn},null),{title:"编辑用户",width:"500px"}).promise;console.log("最终结果:",t)}catch{console.log("用户取消了编辑")}};return(t,a)=>{const f=oe;return b(),D("div",null,[s(f,{onClick:l,type:"success"},{default:p(()=>a[0]||(a[0]=[B("编辑用户 (命令式)")])),_:1,__:[0]})])}}}),ss=`<template>
  <div>
    <!-- 业务内容 -->
...
<\/script>
`,is={__name:"comparison-traditional-basic",setup(e){const i=T(!1),l=T({}),t=()=>{l.value={...Nn},i.value=!0},a=m=>{console.log("提交数据:",m),H.success("用户信息已更新"),i.value=!1},f=()=>{i.value=!1},n=()=>{l.value={}};return(m,v)=>{const d=oe,c=ht;return b(),D("div",null,[s(d,{onClick:t,type:"primary"},{default:p(()=>v[1]||(v[1]=[B("编辑用户 (传统方式)")])),_:1,__:[1]}),s(c,{modelValue:i.value,"onUpdate:modelValue":v[0]||(v[0]=r=>i.value=r),title:"编辑用户",width:"500px",onClose:n},{default:p(()=>[s(wt,{user:l.value,onSubmit:a,onCancel:f},null,8,["user"])]),_:1},8,["modelValue"])])}}},fs=JSON.parse('{"title":"命令式 vs 传统方式对比","description":"","frontmatter":{},"headers":[],"relativePath":"guide/comparison.md","filePath":"guide/comparison.md"}'),rs={name:"guide/comparison.md"},vs=Object.assign(rs,{setup(e){const i=T(!0);return(l,t)=>{const a=Ee("ClientOnly");return b(),D("div",null,[t[9]||(t[9]=et('<h1 id="命令式-vs-传统方式对比" tabindex="-1">命令式 vs 传统方式对比 <a class="header-anchor" href="#命令式-vs-传统方式对比" aria-label="Permalink to &quot;命令式 vs 传统方式对比&quot;">​</a></h1><p>本文档通过实际代码示例对比命令式组件和传统声明式组件的差异，帮助您理解命令式组件的核心优势。</p><h2 id="📊-核心差异概览" tabindex="-1">📊 核心差异概览 <a class="header-anchor" href="#📊-核心差异概览" aria-label="Permalink to &quot;📊 核心差异概览&quot;">​</a></h2><table tabindex="0"><thead><tr><th>特性</th><th>传统声明式</th><th>命令式组件</th><th>优势</th></tr></thead><tbody><tr><td><strong>代码量</strong></td><td>需要模板+状态+事件</td><td>一行函数调用</td><td>显著减少</td></tr><tr><td><strong>状态管理</strong></td><td>手动管理visible状态</td><td>自动管理</td><td>零样板代码</td></tr><tr><td><strong>异步流程</strong></td><td>复杂的事件回调</td><td>Promise支持</td><td>流程清晰</td></tr><tr><td><strong>嵌套处理</strong></td><td>手动层级管理</td><td>自动堆栈管理</td><td>智能处理</td></tr></tbody></table><h2 id="🔍-详细对比示例" tabindex="-1">🔍 详细对比示例 <a class="header-anchor" href="#🔍-详细对比示例" aria-label="Permalink to &quot;🔍 详细对比示例&quot;">​</a></h2><h3 id="_1-基础弹窗调用" tabindex="-1">1. 基础弹窗调用 <a class="header-anchor" href="#_1-基础弹窗调用" aria-label="Permalink to &quot;1. 基础弹窗调用&quot;">​</a></h3><h4 id="传统声明式方式" tabindex="-1">传统声明式方式 <a class="header-anchor" href="#传统声明式方式" aria-label="Permalink to &quot;传统声明式方式&quot;">​</a></h4>',7)),G(s(o(Ce),null,null,512),[[ee,i.value]]),s(a,null,{default:p(()=>[s(o(Ve),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[0]||(t[0]=()=>{i.value=!1}),vueCode:o(ss)},{vue:p(()=>[s(is)]),_:1},8,["vueCode"])]),_:1}),t[10]||(t[10]=V("h4",{id:"命令式组件方式",tabindex:"-1"},[B("命令式组件方式 "),V("a",{class:"header-anchor",href:"#命令式组件方式","aria-label":'Permalink to "命令式组件方式"'},"​")],-1)),G(s(o(Ce),null,null,512),[[ee,i.value]]),s(a,null,{default:p(()=>[s(o(Ve),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[1]||(t[1]=()=>{i.value=!1}),vueCode:o(os)},{vue:p(()=>[s(as)]),_:1},8,["vueCode"])]),_:1}),t[11]||(t[11]=et('<p><strong>对比结果：</strong></p><ul><li>代码量：显著减少，无需模板中的弹窗定义</li><li>状态管理：无需手动管理visible状态</li><li>事件处理：无需编写多个事件处理函数</li><li>异步流程：Promise让逻辑更清晰</li></ul><h3 id="_2-表格行编辑场景" tabindex="-1">2. 表格行编辑场景 <a class="header-anchor" href="#_2-表格行编辑场景" aria-label="Permalink to &quot;2. 表格行编辑场景&quot;">​</a></h3><h4 id="传统声明式方式-1" tabindex="-1">传统声明式方式 <a class="header-anchor" href="#传统声明式方式-1" aria-label="Permalink to &quot;传统声明式方式&quot;">​</a></h4>',4)),G(s(o(Ce),null,null,512),[[ee,i.value]]),s(a,null,{default:p(()=>[s(o(Ve),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[2]||(t[2]=()=>{i.value=!1}),vueCode:o(ts)},{vue:p(()=>[s(ls)]),_:1},8,["vueCode"])]),_:1}),t[12]||(t[12]=V("h4",{id:"命令式组件方式-1",tabindex:"-1"},[B("命令式组件方式 "),V("a",{class:"header-anchor",href:"#命令式组件方式-1","aria-label":'Permalink to "命令式组件方式"'},"​")],-1)),G(s(o(Ce),null,null,512),[[ee,i.value]]),s(a,null,{default:p(()=>[s(o(Ve),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[3]||(t[3]=()=>{i.value=!1}),vueCode:o(Xa)},{vue:p(()=>[s(es)]),_:1},8,["vueCode"])]),_:1}),t[13]||(t[13]=V("p",null,[V("strong",null,"对比结果：")],-1)),t[14]||(t[14]=V("ul",null,[V("li",null,"代码量：大幅减少，无需在模板中定义多个弹窗"),V("li",null,"状态管理：只需要业务数据，无需UI状态"),V("li",null,"事件处理：逻辑集中，无需分散的事件函数"),V("li",null,"异步流程：Promise链让操作流程一目了然")],-1)),t[15]||(t[15]=V("h3",{id:"_3-复杂嵌套弹窗",tabindex:"-1"},[B("3. 复杂嵌套弹窗 "),V("a",{class:"header-anchor",href:"#_3-复杂嵌套弹窗","aria-label":'Permalink to "3. 复杂嵌套弹窗"'},"​")],-1)),t[16]||(t[16]=V("p",null,"嵌套弹窗是一个常见但复杂的场景，传统方式需要手动管理多个弹窗状态和层级关系，而命令式组件能够自动处理这些复杂性。",-1)),G(s(o(Ce),null,null,512),[[ee,i.value]]),s(a,null,{default:p(()=>[s(o(Ve),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[4]||(t[4]=()=>{i.value=!1}),vueCode:o(lo)},{vue:p(()=>[s(Xl)]),_:1},8,["vueCode"])]),_:1}),t[17]||(t[17]=et('<p><strong>对比结果：</strong></p><ul><li>代码量：大幅减少，无需在模板中预定义所有弹窗</li><li>状态管理：无需手动管理多个弹窗状态</li><li>层级管理：自动处理z-index和堆栈关系</li><li>关闭逻辑：自动级联关闭，无需手动管理</li></ul><h3 id="_4-异步流程处理对比" tabindex="-1">4. 异步流程处理对比 <a class="header-anchor" href="#_4-异步流程处理对比" aria-label="Permalink to &quot;4. 异步流程处理对比&quot;">​</a></h3><p>多步骤的异步流程是业务开发中的常见场景，传统方式往往导致复杂的状态管理和回调处理，而命令式组件能够将其转化为清晰的Promise链。</p><h4 id="传统声明式方式-2" tabindex="-1">传统声明式方式 <a class="header-anchor" href="#传统声明式方式-2" aria-label="Permalink to &quot;传统声明式方式&quot;">​</a></h4>',5)),G(s(o(Ce),null,null,512),[[ee,i.value]]),s(a,null,{default:p(()=>[s(o(Ve),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[5]||(t[5]=()=>{i.value=!1}),vueCode:o(xa)},{vue:p(()=>[s(Ya)]),_:1},8,["vueCode"])]),_:1}),t[18]||(t[18]=V("h4",{id:"命令式组件方式-2",tabindex:"-1"},[B("命令式组件方式 "),V("a",{class:"header-anchor",href:"#命令式组件方式-2","aria-label":'Permalink to "命令式组件方式"'},"​")],-1)),G(s(o(Ce),null,null,512),[[ee,i.value]]),s(a,null,{default:p(()=>[s(o(Ve),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[6]||(t[6]=()=>{i.value=!1}),vueCode:o(Ra)},{vue:p(()=>[s(Ga)]),_:1},8,["vueCode"])]),_:1}),t[19]||(t[19]=et('<p><strong>对比结果：</strong></p><ul><li>异步流程：从回调地狱变成清晰的Promise链</li><li>错误处理：统一的try-catch，而非分散的错误处理</li><li>数据传递：直接在函数调用中传递，无需中间状态</li><li>流程控制：线性的代码结构，易于理解和维护</li></ul><h3 id="_5-多弹窗状态管理对比" tabindex="-1">5. 多弹窗状态管理对比 <a class="header-anchor" href="#_5-多弹窗状态管理对比" aria-label="Permalink to &quot;5. 多弹窗状态管理对比&quot;">​</a></h3><p>当页面需要管理多个不同类型的弹窗时，传统方式需要为每个弹窗维护独立的状态，而命令式组件则可以按需创建，用完即销毁。</p><h4 id="传统声明式方式-3" tabindex="-1">传统声明式方式 <a class="header-anchor" href="#传统声明式方式-3" aria-label="Permalink to &quot;传统声明式方式&quot;">​</a></h4>',5)),G(s(o(Ce),null,null,512),[[ee,i.value]]),s(a,null,{default:p(()=>[s(o(Ve),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[7]||(t[7]=()=>{i.value=!1}),vueCode:o(Ba)},{vue:p(()=>[s(Na)]),_:1},8,["vueCode"])]),_:1}),t[20]||(t[20]=V("h4",{id:"命令式组件方式-3",tabindex:"-1"},[B("命令式组件方式 "),V("a",{class:"header-anchor",href:"#命令式组件方式-3","aria-label":'Permalink to "命令式组件方式"'},"​")],-1)),G(s(o(Ce),null,null,512),[[ee,i.value]]),s(a,null,{default:p(()=>[s(o(Ve),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[8]||(t[8]=()=>{i.value=!1}),vueCode:o(ba)},{vue:p(()=>[s(Wa)]),_:1},8,["vueCode"])]),_:1}),t[21]||(t[21]=et('<p><strong>对比结果：</strong></p><ul><li>模板复杂度：无需预定义所有弹窗组件</li><li>状态管理：无需为每个弹窗维护visible状态</li><li>扩展性：添加新弹窗无需修改模板</li><li>内存使用：按需创建，用完即销毁</li></ul><h2 id="🎯-核心优势总结" tabindex="-1">🎯 核心优势总结 <a class="header-anchor" href="#🎯-核心优势总结" aria-label="Permalink to &quot;🎯 核心优势总结&quot;">​</a></h2><h3 id="_1-开发效率提升" tabindex="-1">1. <strong>开发效率提升</strong> <a class="header-anchor" href="#_1-开发效率提升" aria-label="Permalink to &quot;1. **开发效率提升**&quot;">​</a></h3><ul><li>告别繁琐的状态管理和事件处理</li><li>专注业务逻辑，而非基础设施代码</li><li>更少的代码意味着更少的bug和更容易的维护</li></ul><h3 id="_2-代码质量改善" tabindex="-1">2. <strong>代码质量改善</strong> <a class="header-anchor" href="#_2-代码质量改善" aria-label="Permalink to &quot;2. **代码质量改善**&quot;">​</a></h3><ul><li>相关逻辑集中在一处，而非分散在模板和脚本中</li><li>代码流程更符合人类思维逻辑</li><li>完整的TypeScript支持，减少运行时错误</li></ul><h3 id="_3-开发体验优化" tabindex="-1">3. <strong>开发体验优化</strong> <a class="header-anchor" href="#_3-开发体验优化" aria-label="Permalink to &quot;3. **开发体验优化**&quot;">​</a></h3><ul><li>无需考虑状态管理和生命周期</li><li>Promise链式调用，错误处理更清晰</li><li>组件调用方式更灵活，重构成本更低</li></ul><h2 id="🚀-适用场景" tabindex="-1">🚀 适用场景 <a class="header-anchor" href="#🚀-适用场景" aria-label="Permalink to &quot;🚀 适用场景&quot;">​</a></h2><p>命令式组件特别适合以下场景：</p><ul><li>✅ <strong>弹窗类组件</strong>：Dialog、Modal、Drawer等</li><li>✅ <strong>确认类交互</strong>：删除确认、操作确认等</li><li>✅ <strong>表单编辑</strong>：行内编辑、快速编辑等</li><li>✅ <strong>多步骤流程</strong>：向导、分步表单等</li><li>✅ <strong>临时性UI</strong>：提示框、通知等</li></ul><p>而传统声明式方式仍然适合：</p><ul><li>✅ <strong>页面主体内容</strong>：列表、表格、卡片等</li><li>✅ <strong>静态展示组件</strong>：头部、侧边栏、底部等</li><li>✅ <strong>复杂状态组件</strong>：需要复杂状态管理的组件</li></ul><p>通过以上对比可以看出，命令式组件在特定场景下能够显著提升开发效率和代码质量，是传统声明式开发的有力补充。</p>',15))])}}});export{fs as __pageData,vs as default};
