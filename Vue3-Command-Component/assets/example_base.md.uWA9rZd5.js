import{d as f,h as T,c as p,o as m,e as Z,n as B,k as o,r as V,N as F,G as t,w as l,a as r,V as w,L as G,ag as R,F as W,j as d,t as S,p as Q,C as z,ae as x,am as D,an as y}from"./chunks/framework.BJgYmz6B.js";import{G as $,H as L,_ as M,O as I,a3 as N,aN as E,aE as h,aO as U,aR as O,aS as X,aT as q,aP as k,aQ as _}from"./chunks/index.CcuN3P2k.js";const J=$({direction:{type:String,values:["horizontal","vertical"],default:"horizontal"},contentPosition:{type:String,values:["left","center","right"],default:"center"},borderStyle:{type:L(String),default:"solid"}}),Y=f({name:"ElDivider"}),H=f({...Y,props:J,setup(c){const a=c,u=I("divider"),e=T(()=>u.cssVar({"border-style":a.borderStyle}));return(s,i)=>(m(),p("div",{class:B([o(u).b(),o(u).m(s.direction)]),style:F(o(e)),role:"separator"},[s.$slots.default&&s.direction!=="vertical"?(m(),p("div",{key:0,class:B([o(u).e("text"),o(u).is(s.contentPosition)])},[V(s.$slots,"default")],2)):Z("v-if",!0)],6))}});var K=M(H,[["__file","divider.vue"]]);const P=N(K),ee=`<template>
  <div>
...
`,te={class:"flex justify-center items-center"},A=f({__name:"nested",setup(c){const a=E(),u=()=>{a(t(g,{nested:!0},null),{title:"嵌套嵌套,还是嵌套"})};return(e,s)=>{const i=h;return m(),p("div",te,[t(i,{onClick:u},{default:l(()=>s[0]||(s[0]=[r("打开弹窗")])),_:1})])}}}),ne={class:"flex gap-20px flex-wrap"},g=f({__name:"dialog-content",props:{nested:{type:Boolean,default:!1}},emits:["say"],setup(c){w("nested",c.nested),w("content","来自Content的🩷~");const u=G("depth",0);w("depth",u+1);const e=U(!1);console.log("来自vue 实例的全局属性",R().appContext.config.globalProperties.$panda);const s=()=>{var i,n;(n=(i=e.componentRef)==null?void 0:i.value)==null||n.resetPosition()};return(i,n)=>{const v=h,b=P;return m(),p(W,null,[d("div",ne,[t(v,{onClick:n[0]||(n[0]=C=>o(e).destroy())},{default:l(()=>n[6]||(n[6]=[r("destroy")])),_:1}),t(v,{onClick:n[1]||(n[1]=C=>o(e).destroyWithReject())},{default:l(()=>n[7]||(n[7]=[r("destroyWithReject")])),_:1}),t(v,{onClick:n[2]||(n[2]=C=>o(e).destroyWithResolve())},{default:l(()=>n[8]||(n[8]=[r("destroyWithResolve")])),_:1}),t(v,{onClick:n[3]||(n[3]=C=>o(e).hide())},{default:l(()=>n[9]||(n[9]=[r("hide")])),_:1}),t(v,{onClick:n[4]||(n[4]=C=>o(e).show())},{default:l(()=>n[10]||(n[10]=[r("show(😯已经show了)")])),_:1}),t(v,{onClick:s},{default:l(()=>n[11]||(n[11]=[r("弹窗位置复原(用于示例原生组件库暴露属性)")])),_:1}),t(v,{onClick:n[5]||(n[5]=C=>i.$emit("say","panda"))},{default:l(()=>n[12]||(n[12]=[r("emit一个事件,value:'panda'")])),_:1})]),t(b),i.nested?(m(),p(W,{key:0},[t(b,null,{default:l(()=>n[13]||(n[13]=[r("来一场无止境的嵌套吧")])),_:1}),n[14]||(n[14]=d("p",null,"当弹窗嵌套过多页面开始出现闪烁,并不是这个库的问题,element-plus官网也有这个问题😄",-1)),d("p",null,"弹窗深度: "+S(o(u)),1),t(A)],64)):Z("",!0)],64)}}}),oe={class:"flex justify-center items-center"},le=f({__name:"other-ui",setup(c){const a=O(),u=()=>{a(t(g,null,null),{title:"hello world",attrs:{size:"50vw"}})},e=X(),s=()=>{e(t(g,null,null))},i=q(),n=()=>{i(t(g,null,null))};return(v,b)=>{const C=h,j=P;return m(),p("div",null,[d("div",oe,[t(C,{onClick:u},{default:l(()=>b[0]||(b[0]=[r("打开el-drawer")])),_:1}),t(C,{onClick:s},{default:l(()=>b[1]||(b[1]=[r("打开vant-popup")])),_:1}),t(C,{onClick:n},{default:l(()=>b[2]||(b[2]=[r("打开vant-popup(从底部弹出)")])),_:1})]),t(j),b[3]||(b[3]=d("p",{class:"text-center"},"欢迎PR,或者联系我以提供更多组件的适配",-1))])}}}),se=`<template>
  <div class="flex justify-center items-center">
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">})</span></span></code></pre></div><h2 id="其他ui库组件示例" tabindex="-1">其他UI库组件示例 <a class="header-anchor" href="#其他ui库组件示例" aria-label="Permalink to &quot;其他UI库组件示例&quot;">​</a></h2><p>目前另外的适配:</p>`,6)),D(t(o(k),null,null,512),[[y,a.value]]),t(s,null,{default:l(()=>[t(o(_),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:e[7]||(e[7]=()=>{a.value=!1}),vueCode:o(ee)},{vue:l(()=>[t(le)]),_:1},8,["vueCode"])]),_:1})])}}});export{we as __pageData,xe as default};
