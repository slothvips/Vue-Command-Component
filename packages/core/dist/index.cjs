...
const RxRender = (render$1) => {
	...
	return (0, vue.h)((0, vue.defineComponent)({ render: () => render$1() }));
};
const uuid = () => {
...
const isVue3OrHigher = () => {
	return parseInt(vue.version.split(".")[0]) >= 3;
};
...
function commandProviderWithRender(parentInstance, uiComponent, config) {
	...
	if (!parentInstance) (0, vue.render)((0, vue.h)({ setup() {
		parentInstance = (0, vue.getCurrentInstance)();
		return () => null;
	} }), document.body);
	...
	const vnode = (0, vue.createVNode)(/* @__PURE__ */ (0, vue.defineComponent)({ setup() {
		const commandInstance = (0, vue.getCurrentInstance)();
		for (const key in config.provideProps) (0, vue.provide)(key, config.provideProps[key]);
		...
		for (const key of provideKeys) (0, vue.provide)(key, upStreamProvides[key]);
		(0, vue.provide)(CommandComponentConsumerInjectKey, consumer);
		const stack = (0, vue.inject)(CommandComponentStackInjectKey, []);
		consumer.stackIndex = stack.length;
		stack.push(consumer);
		(0, vue.provide)(CommandComponentStackInjectKey, stack);
		consumer.stack = stack;
		return () => (0, vue.h)(uiComponent);
	} }), null, null);
	...
	if (config.fragment) {
		...
		(0, vue.render)((0, vue.h)(vue.Teleport, { to: appendToElement }, vnode), containerEl);
	} else {
		appendToElement.appendChild(containerEl);
		(0, vue.render)(vnode, containerEl);
	}
...
const useConsumer = (warn = true) => {
	...
	return (0, vue.inject)(CommandComponentConsumerInjectKey, () => new Proxy({}, {
...
function createAdapter(options) {
	...
	return function(useConfig) {
		...
		return function commandComponent(contentVNode, commandConfig) {
			const mergedConfig = (0, vue.computed)(() => {
			...
			const finalContentVNode = typeof contentVNode === "function" ? (0, vue.h)(/* @__PURE__ */ (0, vue.defineComponent)({ render: contentVNode })) : contentVNode;
			consumerRef.value = commandProviderWithRender(parentInstance, (0, vue.createVNode)(/* @__PURE__ */ (0, vue.defineComponent)({ setup: () => {
				const mergedConfig$1 = (0, vue.computed)(() => {
...
//#endregion
exports.CommandComponentConsumerInjectKey = CommandComponentConsumerInjectKey;
exports.CommandComponentStackInjectKey = CommandComponentStackInjectKey;
exports.ConsumerEventBus = ConsumerEventBus;
exports.EVENT_NAME = EVENT_NAME;
exports.PromiseWithResolvers = PromiseWithResolvers;
exports.RxRender = RxRender;
exports.activeConsumers = activeConsumers;
exports.busName2EventName = busName2EventName;
exports.commandProviderWithRender = commandProviderWithRender;
exports.createAdapter = createAdapter;
exports.eventName2BusName = eventName2BusName;
exports.getMaxZIndex = getMaxZIndex;
exports.isNull = isNull;
exports.isVue3OrHigher = isVue3OrHigher;
