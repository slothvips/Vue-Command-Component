...
const baseRender$1 = (contentVNode, options) => {
	...
	const handleClosed = (...args) => {
		var _attrs$onClosed;
		consumer.value.emit(__vue_cmd_core.EVENT_NAME.destroy);
	...
	return (0, vue.createVNode)(element_plus.ElDialog, (0, vue.mergeProps)({
		"ref": componentRef,
...
const useDialog = (0, __vue_cmd_core.createAdapter)({
	render: baseRender$1,
...
const baseRender = (contentVNode, { componentRef, visible, onMounted, config, consumer }) => {
	...
	return (0, vue.createVNode)(element_plus.ElDrawer, (0, vue.mergeProps)({
		"ref": componentRef,
		"modelValue": visible.value,
		"onUpdate:modelValue": ($event) => visible.value = $event,
		"onVnodeMounted": onMounted,
...
exports.useDialogWithDrag = useDialogWithDrag;
