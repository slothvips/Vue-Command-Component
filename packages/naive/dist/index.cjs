...
const baseRender$1 = (contentVNode, { componentRef, visible, onMounted, config, consumer }) => {
	const { attrs, slots } = config.value;
	const handleClosed = () => {
		var _attrs$onAfterLeave;
		consumer.value.destroy();
		attrs === null || attrs === void 0 || (_attrs$onAfterLeave = attrs.onAfterLeave) === null || _attrs$onAfterLeave === void 0 || _attrs$onAfterLeave.call(attrs);
	};
	return (0, vue.createVNode)(naive_ui.NModal, (0, vue.mergeProps)({
		"ref": componentRef,
		"show": visible.value,
		"onUpdate:show": ($event) => visible.value = $event,
		"onAfterLeave": handleClosed,
		"onVnodeMounted": onMounted
	}, config.value.attrs), _objectSpread2({ default: () => contentVNode }, slots));
};
const useModal = (0, __vue_cmd_core.createAdapter)({
	render: baseRender$1,
	defaultConfig: { attrs: { closable: true } }
});
const useDialog = (useConfig) => {
	const dialog = useModal(useConfig);
	return (content, config) => {
		return dialog(content, merge_default(config, { attrs: {
			title: "接接接接接接接",
			preset: "dialog"
		} }));
	};
...
const baseRender = (contentVNode, { componentRef, visible, onMounted, config, consumer }) => {
	...
	const handleClosed = () => {
		var _attrs$drawerAttrs, _attrs$drawerAttrs$on;
		consumer.value.destroy();
		attrs === null || attrs === void 0 || (_attrs$drawerAttrs = attrs.drawerAttrs) === null || _attrs$drawerAttrs === void 0 || (_attrs$drawerAttrs$on = _attrs$drawerAttrs.onAfterLeave) === null || _attrs$drawerAttrs$on === void 0 || _attrs$drawerAttrs$on.call(_attrs$drawerAttrs);
	};
	return (0, vue.createVNode)(naive_ui.NDrawer, (0, vue.mergeProps)({
		"ref": componentRef,
		"show": visible.value,
		"onUpdate:show": ($event) => visible.value = $event,
		"onAfterLeave": handleClosed,
		"onVnodeMounted": onMounted
	}, drawerAttrs), { default: () => [(0, vue.createVNode)(naive_ui.NDrawerContent, contentAttrs, _objectSpread2({ default: () => contentVNode }, slots))] });
};
const useDrawer = (0, __vue_cmd_core.createAdapter)({
	render: baseRender,
	defaultConfig: { attrs: { drawerAttrs: {
		width: 300,
		placement: "right"
	} } }
});
