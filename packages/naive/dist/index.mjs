...
const baseRender = (contentVNode, { componentRef, visible, onMounted, config, consumer }) => {
	...
	return createVNode(NDrawer, mergeProps({
		...
		"onAfterLeave": handleClosed,
		"onVnodeMounted": onMounted
	}, drawerAttrs), { default: () => [createVNode(NDrawerContent, contentAttrs, _objectSpread2({ default: () => contentVNode }, slots))] });
};
...
//#endregion
export { useDialog, useDrawer, useModal };